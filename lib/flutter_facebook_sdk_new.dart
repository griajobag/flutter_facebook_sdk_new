...
class FlutterFacebookSdkNew {
  static final FlutterFacebookSdkNew? _singleton = FlutterFacebookSdkNew._internal();

  factory FlutterFacebookSdkNew() {
    return _singleton!;
  }

  FlutterFacebookSdkNew._internal();
